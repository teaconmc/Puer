...
var TPMRTLED_DOOR_SIDE = Resources.idr("door_side.png")

// 896x64
var TPMRTLED_BRAND = Resources.idr("brand.png")

// 896x64 （图片还没做，稍后用户自己提供）
var TPMRTLED_TRAIN_HOLD = Resources.idr("train_hold.png")
