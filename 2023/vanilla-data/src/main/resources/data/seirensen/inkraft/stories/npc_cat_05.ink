...
==purpur_guide==
~ temp chance1 = RANDOM(1,10) + 75
库卡佩修斯：检索舰船货物清单……稍等，在修道院下方的船体结构处，警报系统发现亚空间造物的入侵。
库卡佩修斯：存放[紫珀锭]的容器就在那里。
库卡佩修斯：我评估你此行有{chance1}％的概率可以取得这项物品，不过即便被亵渎之物及其异端仆从杀死，你也可以复活。
* 明白了。
-> ending

==membrane_guide==
~ temp chance2 = RANDOM(1,10) + 30
库卡佩修斯：正在检索舰船战斗报告……在亚空间生物入侵时，有一些名为[幻翼]的奸奇恶魔聚集在舰桥周围。
库卡佩修斯：从它们身上可以提取到名为[幻翼膜]的亚空间生物质材料。
库卡佩修斯：我评估你此行有{chance2}％的概率取得这项物品，不过请赞美上古人类的伟大造物，欧姆弥赛亚的知识结晶，其让你仍然可以被复活。
库卡佩修斯：祝你此行顺利。
* 谢谢。
-> ending
