...
execute as @e[tag=trif] store result score BC int run data get entity @s Pos[0] 100000
execute as @e[tag=trif] store result score AB int run data get entity @s Pos[2] 100000
kill @e[tag=trif]
