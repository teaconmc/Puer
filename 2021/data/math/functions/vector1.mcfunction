execute as @e[tag=math_marker,limit=1] run function math:loop32-1
tp @e[tag=math_marker,limit=1] ~ ~ ~
scoreboard players operation result int < 100 int
execute as @e[tag=math_marker,limit=1] at @s run function math:loop33
execute at @e[tag=math_marker,limit=1] positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^ ^1 {Tags:["stmp","stmp0"]}
...
execute at @e[tag=math_marker,limit=1] facing entity @p eyes positioned 0.0 0.0 0.0 run tp @e[tag=stmp0,limit=1] ^ ^ ^1
...
scoreboard players set result int 5
execute as @e[tag=stmp3] at @s run function math:loop33
scoreboard players set result int 5
execute as @e[tag=stmp4] at @s run function math:loop33
