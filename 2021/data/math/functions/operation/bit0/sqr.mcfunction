...
execute store result entity @s Item.tag.bit0[0] int 1 run scoreboard players operation stemp int %= 10000 int
...
execute store result entity @s Item.tag.bit0[1] int 1 run scoreboard players operation stemp int %= 10000 int
scoreboard players operation stemp1 int /= 10000 int
scoreboard players operation stemp int = stempa int
scoreboard players operation stemp int *= stemp int
execute store result score stemp1 int run scoreboard players operation stemp int += stemp1 int
execute store result entity @s Item.tag.bit0[2] int 1 run scoreboard players operation stemp int %= 10000 int
scoreboard players operation stemp1 int /= 10000 int
execute store result entity @s Item.tag.bit0[3] int 1 run scoreboard players operation stemp int /= 10000 int