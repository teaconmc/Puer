...
#tellraw @a {"score":{"name":"stempbit0","objective":"int"}}
#tellraw @a {"score":{"name":"stempbit1","objective":"int"}}
#tellraw @a {"score":{"name":"stempbit2","objective":"int"}}
#tellraw @a {"score":{"name":"stempbit3","objective":"int"}}
#tellraw @a {"score":{"name":"stempbit4","objective":"int"}}
#say ------
#tellraw @a {"score":{"name":"stemp2","objective":"int"}}
#tellraw @a {"score":{"name":"stemp3","objective":"int"}}
#tellraw @a {"score":{"name":"stemp4","objective":"int"}}
...
execute store result entity @s Item.tag.bit0[0] int 1 run scoreboard players get stempbit0 int
execute store result entity @s Item.tag.bit0[1] int 1 run scoreboard players get stempbit1 int
execute store result entity @s Item.tag.bit0[2] int 1 run scoreboard players get stempbit2 int
execute store result entity @s Item.tag.bit0[3] int 1 run scoreboard players get stempbit3 int
execute store result entity @s Item.tag.bit0[4] int 1 run scoreboard players get stempbit4 int