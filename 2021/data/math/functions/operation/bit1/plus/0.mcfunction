...
execute store result score stempbit0 int run data get entity @s Item.tag.bit1[0]
execute store result score stempbit1 int run data get entity @s Item.tag.bit1[1]
execute store result score stempbit2 int run data get entity @s Item.tag.bit1[2]
execute store result score stempbit3 int run data get entity @s Item.tag.bit1[3]
execute store result score stempbit4 int run data get entity @s Item.tag.bit1[4]
...
execute store result entity @s Item.tag.bit1[0] int 1 run scoreboard players get stempbit0 int
execute store result entity @s Item.tag.bit1[1] int 1 run scoreboard players get stempbit1 int
execute store result entity @s Item.tag.bit1[2] int 1 run scoreboard players get stempbit2 int
execute store result entity @s Item.tag.bit1[3] int 1 run scoreboard players get stempbit3 int
execute store result entity @s Item.tag.bit1[4] int 1 run scoreboard players get stempbit4 int