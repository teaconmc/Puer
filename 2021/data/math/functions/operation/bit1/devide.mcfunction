execute store result score stemp int run data get entity @s Item.tag.bit1[5]
...
execute store result entity @s Item.tag.bit1[5] int 1 run scoreboard players get stemp int



execute store result score stemp2 int store result score stemp int run data get entity @s Item.tag.bit1[4]
execute store result entity @s Item.tag.bit1[4] int 1 run scoreboard players operation stemp int /= stemp1 int
...
execute store result score stemp int run data get entity @s Item.tag.bit1[3]
...
execute store result entity @s Item.tag.bit1[3] int 1 run scoreboard players operation stemp5 int += stemp4 int
execute store result score stemp3 int run scoreboard players operation stemp2 int %= stemp1 int
...
scoreboard players operation stemp5 int *= stemp3 int
scoreboard players operation stemp4 int *= stemp3 int
execute store result score stemp int run data get entity @s Item.tag.bit1[2]
scoreboard players operation stemp5 int += stemp int
execute store result score stemp2 int run scoreboard players operation stemp5 int += stemp2 int
scoreboard players operation stemp5 int /= stemp1 int
execute store result entity @s Item.tag.bit1[2] int 1 run scoreboard players operation stemp5 int += stemp4 int
execute store result score stemp3 int run scoreboard players operation stemp2 int %= stemp1 int
...
scoreboard players operation stemp5 int *= stemp3 int
scoreboard players operation stemp4 int *= stemp3 int
execute store result score stemp int run data get entity @s Item.tag.bit1[1]
scoreboard players operation stemp5 int += stemp int
execute store result score stemp2 int run scoreboard players operation stemp5 int += stemp2 int
scoreboard players operation stemp5 int /= stemp1 int
execute store result entity @s Item.tag.bit1[1] int 1 run scoreboard players operation stemp5 int += stemp4 int
execute store result score stemp3 int run scoreboard players operation stemp2 int %= stemp1 int
...
scoreboard players operation stemp5 int *= stemp3 int
scoreboard players operation stemp4 int *= stemp3 int
execute store result score stemp int run data get entity @s Item.tag.bit1[0]
scoreboard players operation stemp5 int += stemp int
scoreboard players operation stemp5 int += stemp2 int
scoreboard players operation stemp5 int /= stemp1 int
execute store result entity @s Item.tag.bit1[0] int 1 run scoreboard players operation stemp5 int += stemp4 int