execute if score input int < 0 int store result entity @s Item.tag.bit1[5] int -1 run data get entity @s Item.tag.bit1[5]
...
execute store result score 1stemp2 int run data get entity @s Item.tag.bit1[0]
...
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[1]
...
scoreboard players operation 1stemp2 int += 1stemp3 int
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[2]
scoreboard players operation 1stemp3 int *= stemp0 int
scoreboard players operation 1stemp2 int += 1stemp3 int
execute store result score stempbit int run scoreboard players operation 1stemp2 int += stempbit int
...
execute store result score 1stemp2 int run data get entity @s Item.tag.bit1[1]
scoreboard players operation 1stemp2 int *= stemp2 int
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[2]
scoreboard players operation 1stemp3 int *= stemp1 int
scoreboard players operation 1stemp2 int += 1stemp3 int
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[3]
scoreboard players operation 1stemp3 int *= stemp0 int
scoreboard players operation 1stemp2 int += 1stemp3 int
execute store result score stempbit int run scoreboard players operation 1stemp2 int += stempbit int
...
execute store result score 1stemp2 int run data get entity @s Item.tag.bit1[2]
scoreboard players operation 1stemp2 int *= stemp2 int
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[3]
scoreboard players operation 1stemp3 int *= stemp1 int
scoreboard players operation 1stemp2 int += 1stemp3 int
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[4]
scoreboard players operation 1stemp3 int *= stemp0 int
scoreboard players operation 1stemp2 int += 1stemp3 int
execute store result score 1stemp3 int run data get entity @s Item.tag.bit1[3]
...
execute store result entity @s Item.tag.bit1[0] int 1 run scoreboard players get 0stempbit int
execute store result entity @s Item.tag.bit1[1] int 1 run scoreboard players get 1stempbit int
execute store result entity @s Item.tag.bit1[2] int 1 run scoreboard players get 2stempbit int
execute store result entity @s Item.tag.bit1[3] int 1 run scoreboard players get 3stempbit int
execute store result entity @s Item.tag.bit1[4] int 1 run scoreboard players get 4stempbit int