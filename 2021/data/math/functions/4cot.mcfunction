...
execute as @e[tag=trif] store result score BC int run data get entity @s Pos[0] 10000
execute as @e[tag=trif] store result score result int run data get entity @s Pos[2] 100000000
kill @e[tag=trif]
scoreboard players operation result int /= BC int