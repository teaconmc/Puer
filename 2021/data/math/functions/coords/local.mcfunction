...
execute store result score stemp1 int run data get entity @s Item.tag.u[0] 10000
execute store result score stemp2 int run data get entity @s Item.tag.u[1] 10000
execute store result score stemp3 int run data get entity @s Item.tag.u[2] 10000
...
execute store result score stemp1 int run data get entity @s Item.tag.w[0] 10000
execute store result score stemp2 int run data get entity @s Item.tag.w[1] 10000
execute store result score stemp3 int run data get entity @s Item.tag.w[2] 10000
