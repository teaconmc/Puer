...
execute store result score input int run scoreboard players operation stempy2 int -= stempy1 int
...
execute as @e[tag=stmp1] run function math:operation/bit0/mult
scoreboard players operation stempd int *= stempb int
scoreboard players operation stempe int *= stempa int
execute store result score input int run scoreboard players operation stempd int -= stempe int
