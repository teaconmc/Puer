...
execute store result score stemp2 int run scoreboard players operation stemp1 int /= 10000 int
...
execute unless score stemp int = stemp2 int run function math:sqrt/loop