...
execute if score stemp1 int >= input int run scoreboard players operation smax int = stemp int
execute if score stemp1 int < input int run scoreboard players operation smin int = stemp int
execute unless score stemp int = stemp2 int run function math:input/loop1