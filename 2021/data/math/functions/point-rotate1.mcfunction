...
execute if score stemp7 int matches ..-1 run scoreboard players operation stemp7 int *= -1 int
...
execute if score stemp8 int matches ..-1 run scoreboard players operation stemp8 int *= -1 int
execute if score stemp9 int matches ..-1 run scoreboard players operation stemp9 int *= -1 int
...
execute positioned as @e[tag=stmp,limit=1] facing entity @e[tag=stmp1,limit=1] feet run tp @s ~ ~ ~ ~ ~
