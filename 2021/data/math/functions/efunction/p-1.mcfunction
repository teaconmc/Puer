scoreboard players set stemp3 int 10000
...
scoreboard players operation stemp5 int = -1ustemp int
scoreboard players operation stemp5 int *= stemp1 int
scoreboard players operation stemp5 int += stemp2 int
scoreboard players operation stemp5 int /= 10000 int

scoreboard players operation stemp3 int /= stemp5 int
