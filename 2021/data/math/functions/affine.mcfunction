data modify entity @s Item.tag merge value {result:[0.0d,0.0d]}
...
execute store result score stempx1 int run data get entity @s Item.tag.affine[2][0] 10000
execute store result score stempy1 int run data get entity @s Item.tag.affine[2][1] 10000
