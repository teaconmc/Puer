...
execute store result score tempu int run data get entity @s Item.tag.buttons[0].pos[0] 10
execute store result score tempw int run data get entity @s Item.tag.buttons[0].pos[1] 10
execute store result score tempv int run data get entity @s Item.tag.buttons[0].pos[2] 10
...
#tellraw @a {"score":{"name":"tempx","objective":"int"}}
#tellraw @a {"score":{"name":"tempy","objective":"int"}}
#tellraw @a {"score":{"name":"tempz","objective":"int"}}
...
data modify entity @e[tag=tmp,limit=1] Item.id set from entity @s Item.tag.buttons[0].id
data modify entity @e[tag=tmp,limit=1] Item.tag.cd set from entity @s Item.tag.buttons[0].cd
data modify entity @e[tag=tmp,limit=1] Item.tag.run_command set from entity @s Item.tag.buttons[0].run_command
data modify entity @e[tag=tmp,limit=1] CustomName set from entity @s Item.tag.buttons[0].title
execute unless data entity @s Item.tag.buttons[0].title run data modify entity @e[tag=tmp,limit=1] CustomNameVisible set value 0b
...
data modify entity @e[tag=tmp,limit=1] Tags append from entity @s Item.tag.buttons[0].particle
data modify entity @e[tag=tmp,limit=1] Tags append from entity @s Item.tag.buttons[0].spec


tag @e[tag=tmp] add button
...
data remove entity @s Item.tag.buttons[0]
