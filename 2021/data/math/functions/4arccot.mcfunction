summon area_effect_cloud 0.0 1.0 0.0 {Tags:["cank","arctan","arctan1"]}
execute store result entity @e[tag=arctan1,limit=1] Pos[0] double 0.0001 run scoreboard players get input int
