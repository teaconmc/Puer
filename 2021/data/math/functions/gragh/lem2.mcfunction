execute store result entity @s Pos[0] double -0.0001 run scoreboard players get x cn
execute store result entity @s Pos[1] double 0.0001 run scoreboard players get y int
execute store result entity @s Pos[2] double -0.0001 run scoreboard players get z cn
