...
execute unless score bit0 int matches 0 run function math:loop16-0
execute unless score bit1 int matches 0 run function math:loop16-1
execute unless score bit2 int matches 0 run function math:loop16-2
execute unless score bit3 int matches 0 run function math:loop16-3
execute unless score bit4 int matches 0 run function math:loop16-4
execute unless score bit5 int matches 0 run function math:loop16-5
execute unless score bit6 int matches 0 run function math:loop16-6
execute unless score bit7 int matches 0 run function math:loop16-7
