...
execute store result score stemp1 int run data get entity @s Item.tag.cube[0][0] 10
execute store result score stemp2 int run data get entity @s Item.tag.cube[0][1] 10
execute store result score stemp3 int run data get entity @s Item.tag.cube[0][2] 10
execute store result score stemp4 int run data get entity @s Item.tag.cube[1][0] 10
execute store result score stemp5 int run data get entity @s Item.tag.cube[1][1] 10
execute store result score stemp6 int run data get entity @s Item.tag.cube[1][2] 10
...
execute as @e[tag=stmp] run function math:loop5
