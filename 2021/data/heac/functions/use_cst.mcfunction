...
execute as @s[predicate=heac:hand/syringe,team=!heac] at @s run function heac:tools/syringe
execute as @s[predicate=heac:hand/syringe,team=heac] at @s run tellraw @s {"text": "你已经注射过疫苗了，请勿重复注射"}
